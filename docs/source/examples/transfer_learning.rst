...
.. note::
    ...
    - See the notebook `here <https://github.com/freud14/poutyne/blob/master/examples/transfer_learning.ipynb>`_
    - Run in `Google Colab <https://colab.research.google.com/github/freud14/poutyne/blob/master/examples/transfer_learning.ipynb>`_

...
.. note::
    ...
    - See the notebook `here <https://github.com/freud14/poutyne/blob/master/examples/introduction.ipynb>`_
    - Run in `Google Colab <https://colab.research.google.com/github/freud14/poutyne/blob/master/examples/introduction.ipynb>`_

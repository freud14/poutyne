...
class ModelOptimizerInstanciationTest:
    ...
    def test_with_optimizer_object(self):
        ...
        self.assert_optimizer_equality(model.optimizer, optimizer)
    ...
    def test_with_string_optimizer(self):
        ...
        self.assert_optimizer_equality(model.optimizer, expected)
    ...
    def assert_optimizer_equality(self, first, second):
        assert first.state_dict()['param_groups'] == second.state_dict()['param_groups']
